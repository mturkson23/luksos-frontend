...
@Component({
  ...
  templateUrl: './add-web-system-config.component.html',
  styleUrls: ['./add-web-system-config.component.css']
})
export class AddWebSystemConfigsComponent implements OnInit {
